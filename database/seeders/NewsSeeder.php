...
class NewsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $news = [
            [
                'title' => 'EZ Services Expands Operations to New Cities',
                'slug' => 'ez-services-expands-operations-to-new-cities',
