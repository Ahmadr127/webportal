    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" x-data="{ lightbox: false, currentImage: '' }">
            ...
            <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer" 
                 ...
                 @click="lightbox = true; currentImage = '{{ $image['url'] }}'">
                <img src="{{ $image['url'] }}" alt="{{ $image['title'] }}" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500">
            ...
            <div x-show="lightbox" 
                ...
                <img :src="currentImage" alt="Gallery Image" class="max-w-full max-h-full object-contain rounded-lg">
            </div>
        </div>
    </div>
</section>
