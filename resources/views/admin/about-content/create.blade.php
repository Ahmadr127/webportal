    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 border-b">
                <h2 class="text-2xl font-bold text-white">Create New About Section</h2>
            </div>

            <form action="{{ route('admin.about-content.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="section_key" value="{{ old('section_key') }}" required
                ...
                <div class="mb-6">
                    ...
                    <textarea name="content" rows="8" required
                              ...
                              placeholder="Enter the content for this section...">{{ old('content') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Recommended size: 800x600px. Max size: 2MB</p>
                    @error('image')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
