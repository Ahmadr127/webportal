    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 border-b">
                <h2 class="text-2xl font-bold text-white">Create New Slider</h2>
            </div>
            ...
            <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Recommended size: 1920x1080px. Max size: 2MB</p>
                    @error('image')
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" rows="3"
                              ...
                              placeholder="BAYAR PARKIR CEPAT & MUDAH">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
