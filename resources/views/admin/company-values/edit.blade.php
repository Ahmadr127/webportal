    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 border-b">
                <h2 class="text-2xl font-bold text-white">Edit Company Value</h2>
            </div>

            <form action="{{ route('admin.company-values.update', $companyValue) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full">
                        <i class="fas {{ $companyValue->icon }} text-3xl text-blue-600"></i>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="icon" value="{{ old('icon', $companyValue->icon) }}" required
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" rows="4" required
                              ...
                              placeholder="We constantly innovate to provide the best solutions...">{{ old('description', $companyValue->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="number" name="order" value="{{ old('order', $companyValue->order) }}" min="0" required
                    ...
                    <div>
                        ...
                        <div class="flex items-center mt-2">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $companyValue->is_active) ? 'checked' : '' }}
